...
""" cd documents/cs61a/projects/hog"""
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    integers = list(map(int, str(score)))
    if len(integers) == 2:
    ...
    while score0 < goal and score1 < goal:
        ...
        if player == 0:
            if num_rolls0 == 0:
                ...
                score0 = score0 + take_turn(num_rolls0, score1, dice)
            ...
            if num_rolls1 == 0:
                ...
                score1 = score1 + take_turn(num_rolls1, score0, dice)
            if is_swap(score0, score1):
                temp_score0 = score0
                score0 = score1
                score1 = temp_score0
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def gains(score0, score1):
        if who == 0:
            difference0 = score0 - previous_score
            if difference0 > previous_high:
                if difference0 == 1:
                    print(1, "point! That's the biggest gain yet for Player", who)
                else:
                    print(difference0, "points! That's the biggest gain yet for Player", who)
                return announce_highest(who, difference0, score0)
            else: 
                return announce_highest(who, previous_high, score0)
            
        else: 
            difference1 = score1 - previous_score
            if difference1 > previous_high:
                if difference1 == 1:
                    print(1, "point! That's the biggest gain yet for Player", who)
                else:
                    print(difference1, "points! That's the biggest gain yet for Player", who)
                return announce_highest(who, difference1, score1)
            else:
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if is_swap(free_bacon(opponent_score) + score, opponent_score) or free_bacon(opponent_score) >= margin:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
